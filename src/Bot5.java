	...
	static boolean p=false;
	 ...
	 public synchronized void run() {
		 ...
		 if(Math.abs((x-365)*(x-365))+Math.abs((y-385)*(y-385))<42050){
			 ...
			 if(r==0) {
				 if((Math.abs(x-Bot1.x)<10&&(Math.abs(y-Bot1.y)<10))||(Math.abs(x-Bot4.x)<10&&(Math.abs(y-Bot4.y)<10))||(Math.abs(x-Bot3.x)<10&&(Math.abs(y+CarRace.n-Bot3.y)<10))||(Math.abs(x-Bot2.x)<10&&(Math.abs(y-Bot2.y)<10))||(Math.abs(x-Player1.x)<10&&(Math.abs(y-Player1.y)<10))||(Math.abs(x-Player2.c)<10&&(Math.abs(y-Player2.z)<10))) {
				 try {
					 Thread.sleep(500);
					if (Math.abs(x-Bot1.x)<10&&(Math.abs(y-Bot1.y)<10))	{
						Bot1.x+=10;
						Bot1.y+=10;
					}
